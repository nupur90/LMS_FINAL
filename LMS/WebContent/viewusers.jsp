			...
			<div class="row">
				<div class="contetpanel">
					<table class="responstable2">
						...
						<tr>
							<th>ID</th>
							<th data-th="User Details"><span>Employee Name</span></th>
							<th>Username</th>
							<th>Contact</th>
							<th>Email</th>
							<th>Role</th>
						...
						<s:iterator value="adduserList" status="stat">
							<tr>
								<td><s:property value="#stat.index+1" /></td>
								<td><s:property value="fullName" /></td>
								<td><s:property value="userName" /></td>
								<td><s:property value="userContact" /></td>
								<td><s:property value="userEmail" /></td>
								<td><s:property value="userRole" /></td>
								<td><a
									href="getdata?selectuser.userName=<s:property value="userName"/>"
									class="btn btn-primary">View / Edit</a></td>
								<td><a
									href="delete?deluser.userName=<s:property value="userName"/>"
				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
								...
								<div class="crevtbl">
									<div class="crevtblRow">
										...
										<div class="crevtblCell2">
											<input name="updateuser.fullName" class="formtextfield"
												value="%{fullName}" type="text">
											<s:fielderror fieldName="adduser.fullName" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<input name="updateuser.userAddress" class="formtextfield"
												type="text">
											<s:fielderror fieldName="adduser.userAddress" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<input name="updateuser.userContact" class="formtextfield"
												type="text">
											<s:fielderror fieldName="adduser.userContact" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<input name="updateuser.userEmail" class="formtextfield"
												type="text">
											<s:fielderror fieldName="adduser.userEmail" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<input name="adduser.userBirthDate" class="formtextfield"
												type="text">
											<s:fielderror fieldName="adduser.userBirthDate" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<input name="adduser.userName" class="formtextfield"
												type="text">
											<s:fielderror fieldName="adduser.userName" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<input name="adduser.passWord" class="formtextfield"
												type="text">
											<s:fielderror fieldName="adduser.passWord" />
										</div>
									</div>
									...
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<select name="adduser.userRole" class="adduserlistbox1">
												<option>Admin</option>
												<option>User</option>
											</select>
										</div>
							...
							<s:form action="updateUsersByAdmin">
								<div class="crevtblRow">
