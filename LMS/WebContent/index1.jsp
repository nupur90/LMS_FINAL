...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <nav class="navbar navbar-static-top">
    ...
    <div class="navbar-header">
      <a href="index.jsp" class="navbar-brand"><b>Chaitanya</b> Arts</a>
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
      <ul class="nav navbar-nav">
        <li class="active"><a href="<s:url action="HomeAction"/>">Home <span class="sr-only">(current)</span></a></li>
        <li class="dropdown">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="reports.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
          </div>
		  <!-- /.row -->
  ...
  <tr>
    ...
    <td>31/03/2016</td>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2017 <a href="http://mservices.in" target="_blank">MServices Solutions Pvt. Ltd.</a>.</strong> All rights reserved.      </footer>
