...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<!-- Main content -->
			<section class="content"> <!-- Small boxes (Stat box) --> <!-- Main row -->
			<div class="container-fluid">
				<div class="row">

					<s:form action="expensesAction">

						<div class="expense_field">
							<div class="expense_text">Date :</div>
							<div>
								<input name="expenses.expenseDate" class="expense_textbox"
									type="text" placeholder="YYYY-MM-DD" id="to">
								<s:fielderror fieldName="event.eventVenue" />
								</span>
							</div>

							<div class="expense_text">Particular :</div>
							<div>
								<input name="expenses.expenseParticular" class="expense_textbox"
									type="text">
								<s:fielderror fieldName="expenses.expenseParticular" />
							</div>

							<div class="expense_text">Amount :</div>
							<div>
								<input name="expenses.expenseAmount" class="expense_textbox"
									type="text">
								<s:fielderror fieldName="expenses.expenseAmount" />
							</div>

							<div class="expense_btn1">
							...
							<s:iterator value="expenseList" status="stat">
								<fieldset>
									<tr>
										...
										<td><s:property value="expenseParticular" /></td>
										<td><s:property value="expenseAmount" /></td>
					...
					<s:else>
						<div align="center">
							<s:form action="expensesViewAction">
								<input type="submit" class="btn btn-warning"
									value="View Expenses" style="margin: 15px 0px 0px 0px;" />
