...
<script>
	...
	$(function() {
		$("#searchEventForEditEvents").on('keyup', function() {
			$("#SecondForm").submit();
		});
	});
</script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="topbtnbar">
				...
				<a href="<s:url action="ViewPastEventViewAction"/>"
					class="btn btn-success">Past Events</a> <a
					href="<s:url action="ViewUpcomingEventViewAction"/>"
					class="btn btn-success">Upcoming Events</a> <a
					href="<s:url action="ViewClosedEventViewAction"/>"
					class="btn btn-success">Closed Events</a> <br />
			...
			<div class="container-fluid">
				<div class="row">
					...
					<br>
					<form id="SecondForm">
						<s:textfield name="searchEventTwo" id="searchEventForEditEvents"
							size="45" />
					...
					<div class="contentheading">All Events</div>
					...
					<table class="responstable2">
						...
						<s:iterator value="dataForEditEventsJsp">
							<tr>
								...
								<td><a
									href="getDataForViewEvents?retrieveEvents.eventId=<s:property value="eventId"/>"
