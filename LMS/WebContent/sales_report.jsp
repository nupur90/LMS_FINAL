...
<script>
	$(function() {
		$("#eventSales, #companySales").on('change', function() {
			$("#mySalesForm").submit();
		});
	});
</script>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="billstopbar">
						...
						<form id="mySalesForm">
							<div>
								...
								<div>
									<s:select id="eventSales" name="eventSales"
										list="%{eventsSales}" class="billlistbox1" />
								</div>

								<div class="invoicetext1">Owner Company Name :</div>
								<div>
									<s:select id="companySales" name="companySales"
										list="%{companySalesList}" class="billlistbox1" />
								</div>
								<div class="clear"></div>
							</div>
					...
					<table class="responstable2">
						...
						<tr>
							<th>Bill No</th>
							<th data-th="details"><span>Bill Date</span></th>
							<th>Party Name</th>
							<th>Company Name</th>
							<th>Debit Note</th>
							<th>Invoice</th>
						...
						<s:iterator value="dataForSalesReport">
							<tr>
				...
				<div class="bottombtnbar">
					...
					<a href="salesPdfAction" class="btn btn-primary">Generate PDF</a> <a
						href="generateXlsSales" class="btn btn-primary">Generate XLS</a>
				</div>
			</div>
