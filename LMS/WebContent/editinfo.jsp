...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<!-- Main content -->
			<s:form action="OwnData" theme="simple">

				<s:iterator value="ownList">
						...
						<div class="contetpanel">
								...
								<div class="crevtbl">
									<div class="crevtblRow">
										...
										<div class="crevtblCell2">
											<s:textfield name="ownupdate.fullName" value="%{fullName}"
												size="40" />
											<s:fielderror fieldName="ownupdate.fullName" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="ownupdate.userAddress"
												value="%{userAddress}" size="40" />
											<s:fielderror fieldName="ownupdate.userAddress" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="ownupdate.userContact"
												value="%{userContact}" size="40" />
											<s:fielderror fieldName="ownupdate.userContact" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="ownupdate.userEmail" value="%{userEmail}"
												size="40" />
											<s:fielderror fieldName="ownupdate.userEmail" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="ownupdate.userBirthDate"
												value="%{userBirthDate}" size="40" />
											<s:fielderror fieldName="ownupdate.userBirthDate" />
										</div>
									</div>
									<!--  	<div class="crevtblRow"> 
							...
							<div class="crevtblCell2">abhijit.pujari</div> 
									...
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<select name="ownupdate.userRole" class="adduserlistbox1">
												<option>Admin</option>
												<option>User</option>
											</select>
										</div>
