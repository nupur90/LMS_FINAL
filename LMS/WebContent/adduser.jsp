...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<s:form action="addUsersActionByAdmin">
				<!-- Main content -->
							...
							<div class="crevtbl">
								<div class="crevtblRow">
									...
									<div class="crevtblCell2">
										<input name="adduser.fullName" class="formtextfield"
											type="text">
								...
								<div class="crevtblRow">
									...
									<div class="crevtblCell1">:</div>
									<div class="crevtblCell2">
										<input name="adduser.userAddress" class="formtextfield"
											type="text">
								...
								<div class="crevtblRow">
									...
									<div class="crevtblCell1">:</div>
									<div class="crevtblCell2">
										<input name="adduser.userContact" class="formtextfield"
											type="text">
								...
								<div class="crevtblRow">
									...
									<div class="crevtblCell1">:</div>
									<div class="crevtblCell2">
										<input name="adduser.userEmail" class="formtextfield"
											type="text">
