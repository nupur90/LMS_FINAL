...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Update License <small></small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
				<li>View/Edit Event</li>
				<li class="active">Update License</li>
			</ol>
			</section>

			<!-- Main content -->

			<s:form action="FinalUpdateEventsAction">
				<s:iterator value="listForLicenseJsp">
							...
							<div>
								<div class="crevtbl">
									<div class="crevtblRow">
										<div class="crevtblCell">Remarks</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.remarks" value="%{remarks}" />
											<s:fielderror fieldName="updateEvents.remarks" />
										</div>
									</div>
									...
									<div class="crevtblRow">
										<div class="crevtblCell">Amount</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.amount" value="%{amount}" />
											<s:fielderror fieldName="updateEvents.amount" />
										</div>
									</div>

									<div class="crevtblRow">
										<div class="crevtblCell">Person Alloted</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.personAllotted"
												value="%{personAllotted}" />
										</div>
									</div>

									<div class="crevtblRow">
										<div class="crevtblCell">Applied Date of
											License(YYYY-MM-DD)</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.appliedDate" id="to"
												value="%{appliedDate}" />
											<s:fielderror fieldName="updateEvents.appliedDate" />
										</div>
									</div>
									<div class="crevtblRow">
										<div class="crevtblCell">Received Date of License</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.receivedDate" id="from"
												value="%{receivedDate}" />
											<s:fielderror fieldName="updateEvents.receivedDate" />
										</div>
									</div>
									<div class="crevtblRow">
										...
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<select name="updateEvents.ownerCompany"
												class="adduserlistbox1">
											...
											<s:fielderror fieldName="updateEvents.ownerCompany" />
										</div>
									</div>

									<div class="crevtblRow">
										<div class="crevtblCell">DD Submitted</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<select name="updateEvents.ddSubmitted"
												class="adduserlistbox1">
												<option>Yes</option>
												<option>No</option>
											</select>
											<s:fielderror fieldName="updateEvents.ddSubmitted" />
										</div>
									</div>
									<div class="crevtblRow">
										<div class="crevtblCell">DD Number</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.ddNumber" value="%{ddNumber}" />
											<s:fielderror fieldName="updateEvents.ddNumber" />

										</div>
									</div>
									<div class="crevtblRow">
										<div class="crevtblCell">DD Date</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.ddDate" id="to1"
												value="%{ddDate}" />
											<s:fielderror fieldName="updateEvents.ddDate" />
										</div>
									</div>
									<div class="crevtblRow">
										<div class="crevtblCell">DD Amount</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.ddAmount" value="%{ddAmount}" />
											<s:fielderror fieldName="updateEvents.ddAmount" />

										</div>
									</div>
									<div class="crevtblRow">
										<div class="crevtblCell">Bank Name</div>
										<div class="crevtblCell1">:</div>
										<div class="crevtblCell2">
											<s:textfield name="updateEvents.bankName" value="%{bankName}" />
											<s:fielderror fieldName="updateEvents.bankName" />
