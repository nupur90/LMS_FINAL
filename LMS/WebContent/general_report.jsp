...
<script>
	$(function() {
		$("#eventGeneral, #companyGeneral").on('change', function() {
			$("#myFormGeneral").submit();
		});
	});
</script>
</head>
		...
		<div class="content-wrapper">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="billstopbar">
						...
						<div>
							...
							<div class="clear"></div>
								-->
							<form id="myFormGeneral">

								<div>
									<div class="invoicetext1">Event Name :</div>
									&nbsp;&nbsp;
									<s:select id="eventGeneral" name="eventGeneral"
										list="%{eventsGeneral}" class="billlistbox1" />
									<s:select id="companyGeneral" name="companyGeneral"
										list="%{companiesGeneral}" class="billlistbox2" />
				...
				<div class="bottombtnbar">
					<a href="generalPdfAction" class="btn btn-primary">Generate PDF</a>
					<a href="generalXlsAction" class="btn btn-primary">Generate XLS</a>
				</div>
			</div>
