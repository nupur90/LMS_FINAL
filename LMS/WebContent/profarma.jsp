...
<body class="hold-transition skin-blue sidebar-mini" onLoad="init()">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<!-- Main content -->
			<s:form action="profarmaPdfAction">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="debitote_form">
							...
							<div class="debitnotetext1">Profarma</div>
							<div class="invoicedatepanel">

								<div class="invoicetext1">Invoice No. :</div>
								<div>
									<s:textfield name="profarmaPdf.invoiceNumber"
										value="%{invoiceNumber}" class="invoice_formtextbox1" />
								</div>

								<div>
									<s:textfield name="profarmaPdf.eventsDate" value="%{eventDate}"
										class="invoice_formtextbox2" id="to" />
								</div>
							...
							<div>
								<s:textfield name="profarmaPdf.toCompanyName"
									value="%{companyName}" class="debitote_formtextbox1" />
								<s:hidden name="profarmaPdf.eventName" value="%{eventName}"
							...
							<div ng-app>
								<table class="responstable3">
									...
									<tr>
										...
										<th data-th="Amount"><span>Amount</span></th>
									</tr>
									<s:iterator value="profarmaList">

										<tr>
											<td>&nbsp;</td>
											<td><s:property value="licenseName" /> <s:hidden
													name="profarmaPdf.licProName" value="%{licenseName}" /></td>
											<td>&nbsp;</td>
										</tr>
									</s:iterator>
									<tr>
											...
											<table class="responstable4">
												<tr>
													<td style="text-align: left;">Pan No. :&nbsp;<input
														type="text" name="profarmaPdf.panNumber"
												...
												<tr>
													<td style="text-align: left;">Service Tax No. :&nbsp;<input
														type="text" name="profarmaPdf.serviceTaxNumber"
														class="profarma_formtextbox1" /></td>
										...
										<td style="padding: 0px;">
											<table class="responstable4">
												<tr>
													<td><input type="text" name="profarmaPdf.netAmount"
														class="profarma_formtextbox2" ng-model="a" /></td>
												</tr>
												<tr>
													<td><input type="text" name="profarmaPdf.serviceTax"
														class="profarma_formtextbox2" value="{{a*0.14}}" ng-model="b"/></td>
												</tr>
												<tr>
													<td><input type="text" name="profarmaPdf.sbcTax"
														class="profarma_formtextbox2" value="{{a*0.0005}}" /></td>
												</tr>
												<tr>
													<td><input type="text" name="profarmaPdf.kkcTax"
														class="profarma_formtextbox2" value="{{a*0.0005}}" /></td>
												</tr>

												<tr>
													<td><input type="text" name="profarmaPdf.totalAmount"
														class="profarma_formtextbox2"
														value="{{a--b--(a*0.0005)--(a*0.0005)}}" /></td>
												</tr>
											</table>
										</td>
									</tr>
							...
							<div class="debitnotebtn">
								<s:submit value="Generate Profarma" class="btn btn-primary" />
							</div>
