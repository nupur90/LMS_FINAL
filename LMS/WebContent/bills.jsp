...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<form id="myForm">
						...
						<div>
							...
							&nbsp;&nbsp;
							<s:select id="event" name="event" headerKey="-1" headerValue="Select Event Name" list="%{events}"
								class="billlistbox1" />
							<s:select id="company" name="company" headerKey="-1" headerValue="Select Company Name" list="%{companies}"
								class="billlistbox2" />
					...
					<!--  <div>
							...
							<div>
								<input name="formtext1" class="invoice_formtextbox1" type="text"
									id="formtext1"><img src="dist/img/calender_icon.png"
									alt="calender_icon" class="calender_icon2" />
							</div>
							<div>
								<img src="dist/img/calender_icon.png" alt="calender_icon"
									class="calender_icon3" /><input name="formtext1"
									class="invoice_formtextbox2" type="text" id="formtext1">
							</div>
							<div class="invoicetext2">To Date :</div>
							<div class="clear"></div>
						</div>-->
				...
				<table class="responstable2">
					...
					<s:iterator value="dataForBillsJspList">
						<tr>
							...
							<td><a
								...
								class="btn btn-success">P</a>&nbsp; <a
								href="debitAction?debitActionVar.eventId=<s:property value="eventId"/>"
								class="btn btn-success">DN</a>&nbsp; <a
								href="invoiceAction?invoiceActionVar.eventId=<s:property value="eventId"/>"
								class="btn btn-success">I</a></td>
							<td><a
								href="ViewBillsJspDetails?viewBills.eventId=<s:property value="eventId"/>"
								class="btn btn-info">View Details</a></td>
							<td><s:if test="#session.paid_status.equals('PAID')">
	...
	<script type="text/javascript">
		function showEventDetails() {
			...
			var eventData = eventName.options[eventName.selectedIndex].text;
			alert(eventData);
			/*	$.ajax(
						{
							url:'showEventDetails?eventName='+eventName,
							type:'post',
