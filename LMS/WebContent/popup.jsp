...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="viewtbl">
						<div class="invoicetext1">Select Company Name :</div>
				<div><select name="" class="popuplistbox1">
				...
				<div class="popupbtnbar">
						<a href="debitnote.jsp" target="_blank" class="btn btn-primary" role="button">Go</a>					</div>
